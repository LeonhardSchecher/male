...
const {getAllClubs, getClubById, addClub, getTopClubs, deleteClub, getTopClubPlayers} = require("./service/clubsService");
...
app.get("/api/clubs/topPlayer/:id", getTopClubPlayers)
